...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-payment-service-key-change-in-production')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'myshop_payments'),
        'USER': os.environ.get('DB_USER', 'myshop_user'),
