...
if not DEBUG:
    ...
    # Only configure S3 if all required variables are set
    if AWS_ACCESS_KEY_ID and AWS_SECRET_ACCESS_KEY and AWS_STORAGE_BUCKET_NAME:
        ...
        # Fallback to local settings if AWS not properly configured
        STATICFILES_DIRS = [
            BASE_DIR / "static",
        ]
        MEDIA_URL = '/media/'
...
# Only enable SSL redirect if AWS is properly configured
